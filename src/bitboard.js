export default class Bitboard {
  ...
  static makeDiagonal(diagonal) {
    return Bitboard.make(0x10204080, 0x01020408)
      .and(Bitboard.makeOne().shiftLeft(diagonal * 8))
      .shiftLeft(diagonal);
  }
  ...
  static makeAntidiagonal(antidiagonal) {
    return Bitboard.make(0x08040201, 0x80402010)
      .and(Bitboard.makeOne().shiftLeft(-antidiagonal * 8))
  ...
  static makeKnightMovement(index) {
    ...
    var l2 = b
      .dup()
      .shr(2)
      .and_not(Bitboard.FILES[7])
      .and_not(Bitboard.FILES[6]);
    var r1 = b.dup().shl(1).and_not(Bitboard.FILES[0]);
    var r2 = b
      .dup()
      .shl(2)
      .and_not(Bitboard.FILES[0])
      .and_not(Bitboard.FILES[1]);
    var v1 = l2.or(r2);
    var v2 = l1.or(r1);
  ...
  static makeKingMovement(index) {
    ...
    var c = b
      ...
      .shr(1)
      .and_not(Bitboard.FILES[7])
      .or(b.dup().shl(1).and_not(Bitboard.FILES[0]));
