...
export default class Controller {
  ...
  getCaptureSquare = function () {
    ...
    return (
      this.getTo() +
      (this.getFrom() < this.getTo() ? -Chess.FILES : Chess.FILES)
    );
  };
  ...
  getString() {
    if (!this.isCastle()) {
      return (
        Chess.PIECE_ALGEBRAIC_NAMES.charAt(this.getPiece()) +
        ...
        (this.isPromotion()
          ? Chess.PIECE_ALGEBRAIC_NAMES.charAt(this.getPromotedPiece())
          : "")
      );
    }
